...
export default function OrnamentLayerPanel({
  ...
  return (
    <div className="overflow-hidden rounded-[10px] border border-[var(--color-accent-pale)] bg-white shadow-[0_1px_2px_rgba(16,24,40,0.04)] xl:sticky xl:top-4 xl:flex xl:max-h-[calc(100vh-6.5rem)] xl:flex-col">
      <div className="flex items-center justify-between border-b border-[var(--color-accent-pale)] px-3 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <p className="text-xs font-extrabold text-[var(--color-text)]">Layer / Ornamen</p>
        </div>
      ...
      <div className="space-y-2.5 p-3 xl:min-h-0 xl:overflow-y-auto">
        <label className="block">
          <span className="mb-1 block text-[11px] font-bold text-[var(--color-text)]/70">Section</span>
          <SelectInput
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-8 w-full rounded-md border border-[var(--color-accent-pale)] bg-white pl-8 pr-2.5 text-xs font-medium text-[var(--color-text)] outline-none focus:border-[var(--color-accent)]"
            />
          </div>
          <button type="button" className="flex h-8 w-8 items-center justify-center rounded-md border border-[var(--color-accent-pale)] bg-white text-[var(--color-text)]/70 hover:bg-[var(--color-bg)]">
        ...
        <button
          type="button"
          onClick={addOrnament}
          className="inline-flex h-8 w-full items-center justify-center gap-2 rounded-md bg-[var(--color-accent)] px-3 text-xs font-bold text-white hover:brightness-95"
        >
        ...
        <div className="flex items-center justify-between border-t border-[var(--color-accent-pale)] pt-2">
