...
export default function OrnamentLayerPanel({
  ...
  return (
    <div className="overflow-hidden rounded-[14px] border border-[var(--color-accent-pale)] bg-white shadow-[0_1px_2px_rgba(16,24,40,0.04)]">
      <div className="flex items-center justify-between border-b border-[var(--color-accent-pale)] px-4 py-3">
        <div className="flex items-center gap-2">
          <svg viewBox="0 0 20 20" className="h-4 w-4 text-[var(--color-text)]/70" fill="none" stroke="currentColor" strokeWidth="1.8">
            <rect x="4" y="4" width="12" height="3" rx="1" />
            <rect x="4" y="8.5" width="12" height="3" rx="1" />
            <rect x="4" y="13" width="12" height="3" rx="1" />
          </svg>
          <p className="text-[15px] font-extrabold text-[var(--color-text)]">Layer / Ornamen</p>
        </div>
      ...
      <div className="space-y-3 p-4">
        <label className="block">
          <span className="mb-1.5 block text-[12px] font-bold text-[var(--color-text)]/70">Section</span>
          <SelectInput
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-[10px] border border-[var(--color-accent-pale)] bg-white pl-9 pr-3 text-sm font-medium text-[var(--color-text)] outline-none focus:border-[var(--color-accent)]"
            />
          </div>
          <button type="button" className="flex h-10 w-10 items-center justify-center rounded-[10px] border border-[var(--color-accent-pale)] bg-white text-[var(--color-text)]/70 hover:bg-[var(--color-bg)]">
        ...
        <button
          type="button"
          onClick={addOrnament}
          className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-[10px] bg-[var(--color-accent)] px-3 text-sm font-bold text-white hover:brightness-95"
        >
            ...
            .map(({ ornament, index }) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-2 rounded-[10px] px-2 py-2 ${isSelected ? "bg-[var(--color-accent)]/10" : "hover:bg-[var(--color-bg)]"}`}
                >
                  <button
                    type="button"
                  ...
                  >
                    <span className="inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-md border border-[var(--color-accent-pale)] bg-white">
                      {hasImage ? (
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="block text-[12px] font-medium text-[var(--color-text)]/60">Ornamen</span>
                    </span>
                  </button>
        ...
        <div className="flex items-center justify-between border-t border-[var(--color-accent-pale)] pt-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-[var(--color-accent-pale)] bg-white px-2.5 py-1 text-xs font-semibold text-[var(--color-text)] hover:bg-[var(--color-bg)]"
          >
