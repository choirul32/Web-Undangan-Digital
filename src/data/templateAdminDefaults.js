...
// Override template lokal (localStorage) dihapus: semua data template harus
// berasal dari Supabase supaya tidak ada "template hantu" yang tersisa setelah
// dihapus di database. TemplateAdmin sekarang hanya memakai data dari API.
